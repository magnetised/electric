defmodule Electric.Satellite.Permissions.Trigger do
  ...
  """
  @spec create_triggers([%SatPerms.Assign{}], SchemaLoader.Version.t(), callback_fun()) ::
          triggers()
  def create_triggers(assigns, schema_version, trigger_callback_fun)
  ...
  def for_assign(assign, schema_version, trigger_callback_fun)
    ...
    {
      relation,
      &change_trigger(&1, &2, assign, pks, fks, trigger_callback_fun)
    }
  end
